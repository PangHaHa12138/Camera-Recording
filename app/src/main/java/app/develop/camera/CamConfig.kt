...
import app.develop.camera.analyzer.QRAnalyzer
import app.develop.camera.ktx.markAs16by9Layout
import app.develop.camera.ktx.markAs4by3Layout
import app.develop.camera.ui.activities.CaptureActivity
import app.develop.camera.ui.activities.MainActivity
import app.develop.camera.ui.activities.MoreSettings
import app.develop.camera.ui.activities.SecureActivity
import app.develop.camera.ui.activities.SecureMainActivity
import app.develop.camera.ui.activities.VideoCaptureActivity
import app.develop.camera.ui.activities.VideoOnlyActivity
import app.develop.camera.util.edit
...
//        }
    ...
    fun switchMode(mode: CameraMode) {
        ...
        if (isQRMode) {
            ...
            mActivity.captureCircle.visibility = View.GONE
            ...
            mActivity.qrScanToggles.visibility = View.GONE
            mActivity.captureButton.setImageDrawable(null)
            mActivity.captureButton.setBackgroundResource(R.drawable.cbutton_bg)
            mActivity.captureCircle.visibility = View.VISIBLE
            if (isVideoMode) {
                mActivity.captureCircle.setImageResource(R.drawable.recording)
            } else {
                mActivity.captureCircle.setImageResource(R.drawable.camera_shutter)
                mActivity.micOffIcon.visibility = View.GONE
            }
        }
